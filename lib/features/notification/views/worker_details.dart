...
//     required this.resumeUrl, required String workerId,
//   });
...
//                   onPressed: (){
//                    // _submitAcceptance(context, workerId),
//                   }, child: Text('Accept')),
//                 SizedBox(width: 30,),
//                 ElevatedButton(style: AppButtonStyles.smallButton(context),
...
//     );
//   }
//   Future<void> _submitAcceptance(BuildContext context, String workerId) async {
//   try {
//     // Update Firestore document to mark registration as accepted
//     await FirebaseFirestore.instance.collection('workers_request').doc(workerId).update({
//       'registrationAccepted': true,
//     });

//     // Show success message or navigate to a success screen
//     ScaffoldMessenger.of(context).showSnackBar(
//       SnackBar(content: Text('Worker registration accepted')),
//     );
//   } catch (e) {
//     print('Error accepting worker registration: $e');
//     ScaffoldMessenger.of(context).showSnackBar(
//       SnackBar(content: Text('Error accepting registration')),
//     );
//   }
// }
