...
//                           final category = snapshot.data![index].data() as Map<String, dynamic>;
...
//                               onTap: () {
//                               Navigator.push(context, MaterialPageRoute(builder: (context)=> CategoryDetailPage(categoryName: category['name'])));
//                               },
//                               child: Container(
